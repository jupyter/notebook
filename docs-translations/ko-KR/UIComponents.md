...
![Notebook Editor example](docs-translations/ko-KR/resources/resources/Notebook_Editor.GIF "Notebook Editor")
...
![Edit Mode example](docs-translations/ko-KR/resources/resources/edit_mode.GIF "Edit Mode")

 ## 파일 편집기

이제 Notebook Dashboard 안의 Notebook 파일이 아닌 표시된 파일을 선택하여 열어야한다고 한다면, 파일은 파일 편집기로 열립니다.

![File Editor example](docs-translations/ko-KR/resources/resources/file_editor.GIF "File Editor")
