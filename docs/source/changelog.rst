...
- Load server extensions with ConfigManager so that merge happens recursively, unlike normal config values to make it load more consistenly with frontend extensions(:ghpull:`2108`).
