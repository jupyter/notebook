...
flags['pylab']=(
    {'ServerApp' : {'pylab' : 'warn'}},
    "DISABLED: use %pylab or %matplotlib in the notebook to enable matplotlib."
)
flags['no-mathjax']=(
    {'Serverapp' : {'enable_mathjax' : False}},
    """Disable MathJax
...
class ServerApp(JupyterApp):
    ...
    password_required = Bool(False, config=True,
                      ...
                      In such a case, the Jupyter server on localhost is not secure
                      since any user can connect to the Jupyter server via ssh.
    ...
    browser = Unicode(u'', config=True,
                      ...
                      browser when opening the application. If not specified, the
    ...
    def init_webapp(self):
        ...
        if self.password_required and (not self.password):
            self.log.critical("Jupyter servers are configured to only be run with a password.")
