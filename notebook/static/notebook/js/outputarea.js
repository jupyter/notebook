...
define([
    ...
    OutputArea.prototype.style = function () {
        ...
        this.collapse_button.attr('title', i18n._('click to expand output'));
        this.collapse_button.text('. . .');
        
        this.prompt_overlay.addClass('out_prompt_overlay prompt');
        this.prompt_overlay.attr('title', i18n._('click to expand output; double click to hide output'));
    ...
    OutputArea.prototype.scroll_area = function () {
        ...
        this.prompt_overlay.attr('title', i18n._('click to unscroll output; double click to hide'));
        this.scrolled = true;
    };
    ...
    OutputArea.prototype.unscroll_area = function () {
        ...
        this.prompt_overlay.attr('title', i18n._('click to scroll output; double click to hide'));
        this.scrolled = false;
    };
    ...
    OutputArea.prototype._append_javascript_error = function (err, element) {
         ...
         */
        var msg = i18n._("Javascript error adding output!");
        if ( element === undefined ) return;
        element
            .append($('<div/>').text(msg).addClass('js-error'))
            .append($('<div/>').text(err.toString()).addClass('js-error'))
            .append($('<div/>').text(i18n._('See your browser Javascript console for more details.')).addClass('js-error'));
    };
    ...
    OutputArea.prototype.append_execute_result = function (json) {
        ...
        if (this.prompt_area) {
            toinsert.find('div.prompt')
                    ...
                    .empty()
                    .append(
                      $('<bdi>').text(i18n.sprintf(i18n._('Out[%d]:'),n))
                    );
        }
    ...
    OutputArea.prototype.append_unrecognized = function (json) {
        ...
        subarea.append(
            $("<a>")
                .attr("href", "#")
                .text(i18n.sprintf(i18n._("Unrecognized output: %s"),json.output_type))
                .click(function () {
