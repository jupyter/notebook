...
def isolated_html(notebook):
    ...
    non_isolated_div = notebook.body.find_element(by=By.ID, value="non-isolated")
    ...
    test_div = notebook.body.find_element(by=By.ID, value="test")
    ...
    isolated_div = notebook.browser.find_element(by=By.ID, value="isolated")
...
def isolated_svg(notebook):
    ...
    isolated_svg_1 = notebook.browser.find_element(by=By.ID, value='r1')
    ...
    isolated_svg_2 = notebook.browser.find_element(by=By.ID, value='r2')
